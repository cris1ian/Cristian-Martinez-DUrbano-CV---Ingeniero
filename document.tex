...
\begin{document}
	...
	\begin{itemize}
		...
		\textbf{Magrathea} es un proyecto de domótica basado en los microcontroladores ATmega328P y NodeMCU para automatización hogareña. Posee un servidor web embebido donde se monitorean entradas y salidas y su casing fue hecho con una impresora 3D con diseño propio.
		\\ 
